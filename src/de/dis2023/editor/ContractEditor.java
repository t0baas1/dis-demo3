	...
	public void showContracts() {
		...
		while(itmv.hasNext()) {
			...
			System.out.println("Tenancy contract "+mv.getContractNo()+"\n"+
							...
							"\tApartment:"+mv.getApartment().getStreet()+" "+mv.getApartment().getSquareArea()+", "+mv.getApartment().getPostalcode()+" "+mv.getApartment().getCity()+"\n"+
							"\tPrice:    "+mv.getApartment().getRent()+" Euro, additional costs : "+mv.getEstate()+" Euro\n" +
